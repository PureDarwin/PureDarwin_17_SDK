...
#include <stdint.h>
#include <math/appleexts.h>
#if !defined(__ISO_C_VISIBLE)
#define ____ISO_C_VISIBLE_WAS_NOT_DEFINED 1
#define __ISO_C_VISIBLE 1999
#endif /* !defined(__ISO_C_VISIBLE) */
#endif /* defined(__APPLE__) */

/* These headers aren't available on Windows */
...
#define	FP_ZERO		0x10
    ...
    __has_extension(c_generic_selections) || defined(__APPLE__)
 ...
 * XOPEN/SVID
 */
#if __BSD_VISIBLE || __XSI_VISIBLE || __APPLE__
 ...
 * ANSI/POSIX
 */
#if !defined(__APPLE__) /* Darwin has these in their own header with the correct signatures */
...
#if defined(____ISO_C_VISIBLE_WAS_NOT_DEFINED)
#undef __ISO_C_VISIBLE
#endif /* defined(____ISO_C_VISIBLE_WAS_NOT_DEFINED) */
